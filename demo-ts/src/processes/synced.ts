...
export class SingleProc {
	...
	startOrChain<T>(action: Action<T>): Promise<T> {
		...
		this.runIfIdle(); // eslint-disable-line @typescript-eslint/no-floating-promises
 ...
 */
export function makeSyncedFunc<T extends Function>( // eslint-disable-line @typescript-eslint/ban-types
